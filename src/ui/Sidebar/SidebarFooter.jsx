    ...
    >
      <div
        className=" w-full max-w-[92%] mx-auto flex items-center justify-start gap-x-2
         p-1.5 rounded-3xl ring-1 ring-gray-200/80 duration-300 bg-blue-300/ "
      >
        <img
          src={profileImage}
        ...
        {editMode ? (
          ...
          <p className="text-[14.8px] mx-1 text-gray-950 text-shadow-gray-90  w-[150px] truncate  font-medium duration-300">
            {userName}
          </p>
        )}
