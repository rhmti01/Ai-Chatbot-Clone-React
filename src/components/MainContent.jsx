...
function MainContent() {
  return (
    <div className="  h-dvh w-full bg-gradient-main text-text flex justify-center  ">
      {/* main interance title */}
      <div className=" pt-[35vh] text-center space-y-3 ">
        <h1 className=" font-medium px-3 py-1.5 inline-block bg-surface rounded-3xl text-md tracking-wider shadow-gray-100 shadow-sm ">
          CHAT A.I+
        </h1>
      ...
      >
        ...
        <input
          ...
          placeholder:text-sub focus:placeholder:text-stone-400/85 peer duration-300 "
          type="text"
          name="prompt-input"
